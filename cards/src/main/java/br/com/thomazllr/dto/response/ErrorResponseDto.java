...
public class ErrorResponseDto {
    ...
    @Schema(description = "Caminho da requisição que gerou o erro", example = "uri=/cards")
    private String apiPath;

    @Schema(description = "Código HTTP do erro", example = "BAD_REQUEST")
    private HttpStatus errorCode;

    @Schema(description = "Mensagem detalhando o erro", example = "Card already registered with the given mobile number")
