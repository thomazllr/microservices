...
@Data
@Builder
@Schema(name = "CustomerResponse", description = "Resposta com os dados do cliente, conta, cartões, empréstimos")
public class CustomerDetailsResponse {
    ...
    @Schema(description = "Dados do cartão vinculado")
    private CardResponse card;
    @Schema(description = "Dados de empréstimo vinculado")
